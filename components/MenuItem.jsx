    ...
    <div className="relative w-full mt-4 justify-between">
      <div className="flex justify-between items-center">
        ...
        <div className="flex justify-center items-center">
          ...
          <div className="flex justify-end items-end">
            <p className="w-12 md:w-12 text-sm md:text-[16px] font-base font-black text-[18px] text-secondary">
              {price} ₺
            </p>
          </div>
        </div>
      ...
      {extras?.map((item, index) => (
        <div key={index} className="flex justify-between text-left text-sm font-alt font-black gap-2 mt-2">
          ...
          {item.title}
          <button onClick={()=> onClick(item)} className="text-white text-[12px] md:text-[14px] font-alt px-2 bg-secondary">
            Hikayesi
            </button>
          </h4>
          <div className="flex justify-center items-center">
            ...
            <div className="flex justify-end items-end">
              <p className="w-12 md:w-14 text-xs md:text-base font-base font-regular text-secondary">
                + {item.price} ₺
              </p>
            </div>
          </div>
